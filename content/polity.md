...
* **Article 72:** Power to grant pardons, reprieves, or remissions of punishment.

---

## 🗳️ Election & Eligibility
...
2. Elected members of the Legislative Assemblies of the States (MLA).
3. Elected members of UTs of Delhi and Puducherry.
...
* Appoints the **Prime Minister**, Attorney General, CAG, and Governors.

### 2. Legislative Powers
* Summons and prorogues the Parliament.
* Can dissolve the Lok Sabha.
* **Ordinance Making Power (Article 123):** Can promulgate ordinances when Parliament is not in session.

### 3. Veto Powers
* **Absolute Veto:** Withholding assent to a bill.
* **Suspensive Veto:** Returning a bill for reconsideration.
* **Pocket Veto:** Taking no action on a bill indefinitely.

---

## 🚫 Impeachment (Article 61)
The President can be removed from office only for **"Violation of the Constitution."**
* The charges can be initiated by **either House** of Parliament.
* Requires a **2/3rd majority** of the total membership of the house.

---

> **Exam Tip:** The President is a nominal executive (*De jure* head), while the Prime Minister is the real executive (*De facto* head).
